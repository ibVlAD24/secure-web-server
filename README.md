...
3. В поле **Name your file** напиши `README.md`
4. **Скопируй весь текст выше** и вставь его в большое поле
5. Нажми **Commit new file**

---

**Готово!** Теперь твой проект выглядит как профессиональный. Можешь скинуть ссылку друзьям или в резюме.
